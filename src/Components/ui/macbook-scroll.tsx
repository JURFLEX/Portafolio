...
import { BackgroundGradientAnimationCP } from "./View_ui/BackgroundGradientAnimationCP";
...
export const MacbookScroll = ({
    ...
    const scaleX = useTransform(
        scrollYProgress,
        [0, 0.3],
        [1.2, isMobile ? 1.5 : 1.4]
    );
    const scaleY = useTransform(
        scrollYProgress,
        [0, 0.3],
        [0.6, isMobile ? 1.4 : 1.4]
    );
    ...
    return (
        ...
        <motion.h2
                ...
                className="dark:text-white text-neutral-800 text-3xl font-bold mt-28 text-center px-4"
            >
                {title || (
                    <span>
        ...
        <div
            ref={ref}
            className="min-h-[200vh] max-sm:min-h-[150vh] flex flex-col items-center py-6  md:py-60 justify-start   transform md:scale-100  scale-[0.45]"
        >
